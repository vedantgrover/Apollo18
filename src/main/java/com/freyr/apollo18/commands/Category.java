...
public enum Category {
    ...
    UTILITY("Utility", ":tools:"), MUSIC("Music", ":musical_note:"), INFORMATION("Information", ":thinking:"), FUN("Fun", ":balloon:"), LEVELING("Leveling", "\uD83D\uDCC8"), ECONOMY("Economy", "<:byte:858172448900644874>"), SETTINGS("Settings", ":gear:");
